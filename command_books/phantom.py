...
SKILL_COOLDOWNS = {
    'ctrl': 0,       # Mille Aiguilles (primary attack, hold left/right)
    'shift': 18,     # Hex Tempest 18 sec
    'q': 15,         # Ace in the Hole 15 sec
    'w': 30,         # Phantom's Mark 30 sec
    '1': 30,         # Rift Break 30 sec
    '2': 30,         # Carte Rose Finale 30 sec
